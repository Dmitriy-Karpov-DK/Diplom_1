...
class TestIngredient:
    ...
    def test_ingredient_get_price_successful(self, ingredient):

        assert ingredient.get_price() == Constants.INGREDIENT_PRICE

    def test_ingredient_get_name_successful(self, ingredient):
        assert ingredient.get_name() == Constants.INGREDIENT_NAME

    def test_ingredient_get_type_successful(self, ingredient):
        assert ingredient.get_type() == Constants.INGREDIENT_TYPE
